...
SELECT users.id, users.first_name, users.last_name, users.email, users.age, users.phone, users.created_at, users.updated_at, user_address.user_id, user_address.country, user_address.city, user_address.street_address, user_address.postal_code, user_address.created_at, user_address.updated_at
FROM users
