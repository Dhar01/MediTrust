...
// func CreateMedicineHandler(service MedicineService) gin.HandlerFunc {
...
// 			return
// 		}
// 		if err := service.CreateMedicine(newMedicine); err != nil {
// 			ctx.JSON(http.StatusInternalServerError, errorMsg(err))
// 			return
// 		}
// 		ctx.JSON(http.StatusCreated, newMedicine)
// 	}
// }

// func (app MedicineApp) CreateMedicine(ctx *gin.Context) {
// 	var newMedicine models.Medicine
// 	if err := ctx.ShouldBindJSON(&newMedicine); err != nil {
// 		ctx.JSON(http.StatusBadRequest, errorMsg(err))
// 		return
